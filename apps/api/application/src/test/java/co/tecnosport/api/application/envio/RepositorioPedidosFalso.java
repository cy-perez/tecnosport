...
final class RepositorioPedidosFalso implements RepositorioPedidos {
  ...
  /**
   * Lo deduce de los pedidos guardados y además admite sembrarlo a mano: hay pruebas que quieren un
   * comprador con rechazo previo sin montarle el pedido entero que lo produjo.
   */
  @Override
