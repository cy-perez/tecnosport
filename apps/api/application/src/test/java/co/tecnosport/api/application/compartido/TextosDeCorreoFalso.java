 ...
 * calendario"— se prueba donde vive el texto, en {@code TextosDeCorreoTest} de infraestructura, y
 * no aquí: una prueba de aplicación que afirme sobre la prosa vuelve a atar el caso de uso al
 * idioma del que se acaba de soltar.
 */
