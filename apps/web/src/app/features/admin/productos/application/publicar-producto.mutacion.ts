...
export function usarPublicarProducto() {
  ...
  return injectMutation(() => ({
    ...
    onSuccess: async () => {
      // La lista lleva el filtro dentro de su llave —una por página y orden—, así que se
      // invalida el prefijo: publicar desde la página 2 tiene que refrescar también la 1.
